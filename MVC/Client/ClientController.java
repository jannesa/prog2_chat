...
public class ClientController {
    ...
    public ClientController(ClientView view, Client client ) {
        ...
        //Listener for send button in public chat.
        ...
        //Actionlistener for UserOnlineList or listener for selecting a private chat.
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        if (e.getClickCount() == 2) {
                            ...
                            SwingUtilities.invokeLater(
                                    new Runnable() {
                                        public void run() {
                                            //Starting a private chat with selected user.
